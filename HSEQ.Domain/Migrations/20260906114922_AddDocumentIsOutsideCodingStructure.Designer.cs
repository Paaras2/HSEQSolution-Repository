...
namespace HSEQ.Domain.Migrations
{
    ...
    [Migration("20260906114922_AddDocumentIsOutsideCodingStructure")]
    partial class AddDocumentIsOutsideCodingStructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HSEQ.Domain.Entities.Document", b =>
                {
                    ...
                    b.Property<bool>("IsOutsideCodingStructure")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HSEQ.Domain.Entities.DocumentRelation", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HSEQ.Domain.Entities.DocumentRelation", b =>
                {
                    b.HasOne("HSEQ.Domain.Entities.Document", "SourceDocument")
                        .WithMany()
                        .HasForeignKey("SourceDocumentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HSEQ.Domain.Entities.Document", "TargetDocument")
                        .WithMany()
